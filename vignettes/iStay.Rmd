...
>>>>>>> 2e434b189b95511b1446718a5b9ee55b9e26797b
...
Run the following code to obtain hierarchical stability-profile, and the ratio for the decomposition of overall stability and synchrony of each hierarchical level: 

```{r, fig.align='left', fig.width = 5, fig.height = 4.5}
